...
val modVersion = project.findProperty("mod_version") as String? ?: "2.1.7+mc1.21.8-1.21.7-backport"
val minecraftVersion = project.findProperty("minecraft_version") as String? ?: "1.21.8"
val loaderVersion = project.findProperty("loader_version") as String? ?: "0.17.2"
val fabricApiVersion = project.findProperty("fabric_api_version") as String? ?: "0.129.0+1.21.8"
...
dependencies {
    ...
    // GeckoLib 5.2.1 is published for Minecraft 1.21.7-1.21.8.
    modImplementation("maven.modrinth:8BmcQJ2H:OT6teuDe")
