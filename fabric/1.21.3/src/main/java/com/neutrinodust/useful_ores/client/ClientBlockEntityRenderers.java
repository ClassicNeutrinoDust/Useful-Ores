...
public class ClientBlockEntityRenderers {
    ...
    public static void register() {
        ...
        BlockEntityRendererRegistry.register(ModBlockEntities.SUPER_BEACON, ctx -> new SuperBeaconRenderer(ctx));
        ...
        BlockEntityRendererRegistry.register(ModBlockEntities.NYXIUM_DARK_BARRIER, ctx -> new VisibleGeoBlockRenderer<>(new NyxiumDarkBarrierGeoModel(), new net.minecraft.world.phys.AABB(-2.0D, 0.0D, -2.0D, 3.0D, 4.5D, 3.0D)));
