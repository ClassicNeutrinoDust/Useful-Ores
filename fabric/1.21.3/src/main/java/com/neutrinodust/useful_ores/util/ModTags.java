...
public class ModTags {
   public interface Blocks {
      ...
      TagKey<Block> INCORRECT_FOR_VOIDSHARD_TOOL = createTag(ResourceLocation.parse("useful_ores:incorrect_for_voidshard_tool"));

      private static TagKey<Block> createTag(ResourceLocation name) {
