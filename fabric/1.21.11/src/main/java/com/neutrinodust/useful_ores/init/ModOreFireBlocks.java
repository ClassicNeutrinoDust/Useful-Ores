...
public class ModOreFireBlocks {
    ...
    public static final Map<String, ModRegisters.RegisteredBlock<Block>> FIRE_BLOCKS = new LinkedHashMap<>();

    public static final Map<String, Integer> COLORS = new LinkedHashMap<>();

    public static final Map<Block, ModRegisters.RegisteredBlock<Block>> IGNITABLE_TO_FIRE = new LinkedHashMap<>();

    static {
        for (OreFireEntry e : ENTRIES) {
            ModRegisters.RegisteredBlock<Block> fire = ModRegisters.registerBlock(
                e.name() + "_fire",
    ...
    public static void buildIgnitionMap() {
        ...
        put("enderium",   ModItems.ENDERIUM_BLOCKS,   null);
        put("nyxium",     ModItems.NYXIUM_BLOCKS,     null);
        ...
        put("osmium",     ModItems.OSMIUM_BLOCKS,     ModItems.DEEPSLATE_OSMIUM_ORE);
        put("solarite",   ModItems.SOLARITE_BLOCKS,   null);
        ...
        put("voidshard",  ModItems.VOIDSHARD_BLOCKS,  null);
        put("lonsdaleite", ModItems.LONSDALEITE_BLOCKS, null);
    }

    private static void put(String name, java.util.List<ModRegisters.RegisteredBlock<Block>> blocks,
                             ModRegisters.RegisteredBlock<Block> deepslateOre) {
        ModRegisters.RegisteredBlock<Block> fire = FIRE_BLOCKS.get(name);
        for (ModRegisters.RegisteredBlock<Block> block : blocks) {
            IGNITABLE_TO_FIRE.put(block.get(), fire);
        }
