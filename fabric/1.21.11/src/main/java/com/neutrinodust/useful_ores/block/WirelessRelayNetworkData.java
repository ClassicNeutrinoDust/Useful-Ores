...
public class WirelessRelayNetworkData extends SavedData {
   ...
   public static final SavedDataType<WirelessRelayNetworkData> TYPE = new SavedDataType<>(
         Identifier.fromNamespaceAndPath("useful_ores", "wireless_relay_network").toString(),
