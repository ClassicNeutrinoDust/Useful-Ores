...
import com.neutrinodust.useful_ores.init.ModRegisters.RegisteredBlock;
...
public class ModOreLightBlocks {
    ...
    public static final Map<String, RegisteredBlock<Block>> TORCHES = new LinkedHashMap<>();

    public static final Map<String, RegisteredBlock<Block>> WALL_TORCHES = new LinkedHashMap<>();

    public static final Map<String, RegisteredItem<Item>> TORCH_ITEMS = new LinkedHashMap<>();

    public static final Map<String, RegisteredBlock<Block>> LANTERNS = new LinkedHashMap<>();
    ...
    static {
        for (Entry e : ENTRIES) {
            ...
            RegisteredBlock<Block> wallTorch = ModRegisters.registerBlock(
                    name + "_wall_torch",
            ...
            RegisteredBlock<Block> torch = ModRegisters.registerBlock(
                    name + "_torch",
            ...
            RegisteredItem<Item> torchItem = ModRegisters.registerItem(
                    name + "_torch",
            ...
            RegisteredBlock<Block> lantern = ModRegisters.registerBlock(
                    name + "_lantern",
