...
public class ModColoredCampfireBlocks {
    ...
    public static final Map<String, DeferredBlock<Block>> CAMPFIRE_BLOCKS = new LinkedHashMap<>();

    public static final Map<String, Integer> COLORS = new LinkedHashMap<>();

    public static final Map<String, DeferredItem<Item>> INFUSED_COAL_ITEMS = new LinkedHashMap<>();

    public static DeferredBlock<Block> VOIDSHARD_CAMPFIRE;
    ...
    static {
        for (CampfireEntry e : ENTRIES) {
            ...
            DeferredBlock<Block> campfire = ModRegisters.registerBlock(
                e.name() + "_campfire",
            ...
            DeferredItem<Item> infusedCoal = ModRegisters.registerItem(
