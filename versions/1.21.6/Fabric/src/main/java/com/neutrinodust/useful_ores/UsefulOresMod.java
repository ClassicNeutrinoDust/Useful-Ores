...
public class UsefulOresMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        com.neutrinodust.useful_ores.pedestal.AncientPedestalMapLootFunction.init();
        ...
        ModSpearSounds.init();
        com.neutrinodust.useful_ores.combat.SpearUseStateSync.register();
        PlayerBlockBreakEvents.BEFORE.register((world, player, pos, state, blockEntity) -> {
            com.neutrinodust.useful_ores.combat.SpearUseStateSync.cancelOnBlockBreak(player);
            return true;
        });
        ...
        com.neutrinodust.useful_ores.item.SperryliteVialDirtEvents.register();
