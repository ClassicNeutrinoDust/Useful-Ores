...
public class ModTitaniumRailBlocks {
    ...
    public static final DeferredBlock<Block> TITANIUM_RAIL = ModRegisters.registerBlock(
        "titanium_rail",
    ...
    public static final DeferredBlock<Block> TITANIUM_CONTROLLER_RAIL = ModRegisters.registerBlock(
