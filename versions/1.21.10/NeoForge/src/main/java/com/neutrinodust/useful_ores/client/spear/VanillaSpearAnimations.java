...
/** Exact 1.21.11 vanilla SpearAnimations math, with the missing 1.21.10 component/state data supplied by SpearAnimationProfile. */
public final class VanillaSpearAnimations {
    ...
    public static void thirdPersonUseItem(ArmedEntityRenderState state, PoseStack pose, float timeHeld, float attackTime, HumanoidArm arm, ItemStack stack) {
        ...
        float feedback=hitFeedbackAmount(10.0F); // no 1.21.10 kinetic-hit render-state; neutral
