...
/**
 * NeoForge host for the exact V100.3 Fabric spear gameplay contract.
 * The old NeoForge kinetic implementation has deliberately been removed;
 * charge contact/damage is owned by SpearChargeCombat.
 */
public final class BackportSpearItem extends Item {
    ...
    @Override
    public ItemUseAnimation getUseAnimation(ItemStack stack) { return ItemUseAnimation.SPEAR; }
    ...
    public void hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        // Dedicated spear jab/charge paths own combat; do not run a second spear damage pipeline.
    }
