...
/**
 * Backported representation of the 1.21.11 vanilla KineticWeapon parameters.
 * The 1.21.10 game does not expose Item.Properties.spear/KineticWeapon, so the
...
public record SpearAnimationProfile(
    ...
    public static SpearAnimationProfile forStack(ItemStack stack) {
        ...
        // Useful Ores spear tuning table retained from the 1.21.11 port.
