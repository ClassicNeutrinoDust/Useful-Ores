...
/** Backported 1.21.11 spear use/charge behavior for Minecraft 1.21.10. */
public class SpearItem extends Item {
    ...
    /**
     * Vanilla 1.21.11 KineticWeapon is invoked by the active-use tick dispatcher.
     * Recreate that ownership directly here so charge timing cannot drift relative
     * to LivingEntity.updateUsingItem or server tick ordering.
     */
    @Override
