...
/** 1.21.3 legacy-model bridge for predicates formerly expressed by 1.21.4 item definitions. */
...
public final class LegacyItemProperties {
    ...
    /**
     * NeoForge 1.21.3 replacement for the 1.21.4 minecraft:potion tint source.
     * The generated vial models use tint index 0 for the liquid overlay.
     */
    @SubscribeEvent
    ...
    private static void register() {
        ...
        // custom_model_data is already a vanilla 1.21.3 predicate, so no mod-side provider is needed.
    }
