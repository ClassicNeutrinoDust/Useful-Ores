...
/**
 * Makes the side-loaded 1.21.3 item models behave like flat item models in the 1.21.4
 * item-model pipeline.  The wrapper always disables block lighting.  For the three
 * affected GUI icon families it can additionally remove BakedQuad directional shading.
 */
