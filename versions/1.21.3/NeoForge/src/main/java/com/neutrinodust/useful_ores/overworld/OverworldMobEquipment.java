...
public final class OverworldMobEquipment {
    ...
    private static final class MaterialTier {
        final List<net.neoforged.neoforge.registries.DeferredItem<Item>> items;
        final float fullChance;
        final float twoChance;
        final float oneChance;
        MaterialTier(List<net.neoforged.neoforge.registries.DeferredItem<Item>> items, float fullChance, float twoChance, float oneChance) {
