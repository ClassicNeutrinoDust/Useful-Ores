...
public class SolariteFurnaceRenderer<T extends SolariteFurnaceBlockEntity> implements net.minecraft.client.renderer.blockentity.BlockEntityRenderer<T> {
    ...
    /**
     * The furnace renderer covers a 2x2 block structure and the authored
     * GeckoLib geometry declares a larger visible envelope (4x3.5).
     * Returning the authored envelope prevents the renderer from being
     * frustum-culled as soon as the multiblock reaches the screen edge.
     */
    public net.minecraft.world.phys.AABB getRenderBoundingBox(T furnace) {
        BlockPos pos = furnace.getBlockPos();
        return new net.minecraft.world.phys.AABB(
                pos.getX() - 1.5D, pos.getY() - 0.5D, pos.getZ() - 1.5D,
