...
/**
 * Registers only models that do not occupy the item's canonical 1.21.3 inventory slot.
 * The canonical item model is still loaded by Minecraft's ordinary ItemRenderer path.
 */
