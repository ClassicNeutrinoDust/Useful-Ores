...
public class ClientBlockEntityRenderers {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.SUPER_BEACON.get(), ctx -> new BeaconRenderer<>());
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.FULGURITE_ELECTRIC_TRAP.get(), FulguriteElectricTrapRenderer::new);

        event.registerBlockEntityRenderer(ModBlockEntities.NYXIUM_DARK_BARRIER.get(), NyxiumDarkBarrierRenderer::new);
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.ANCIENT_PEDESTAL.get(), AncientPedestalRenderer::new);

        event.registerBlockEntityRenderer(ModBlockEntities.DARK_WORMHOLE_PORTAL.get(), DarkWormholePortalRenderer::new);
