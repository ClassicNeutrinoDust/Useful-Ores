...
public class SolariteFurnaceScreen extends AbstractContainerScreen<SolariteFurnaceMenu> {
    ...
    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath("useful_ores", "textures/gui/container/solarite_furnace.png");
    ...
    protected void extractLabels(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        graphics.text(this.font, label, statusX, this.inventoryLabelY, color, false);
