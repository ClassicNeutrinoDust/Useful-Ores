...
public class ModVoidshardLightBlocks {
    ...
    public static RegisteredBlock<Block> VOIDSHARD_TORCH;
    public static RegisteredBlock<Block> VOIDSHARD_WALL_TORCH;
    public static RegisteredBlock<Block> VOIDSHARD_LANTERN;
    public static RegisteredItem<Item> VOIDSHARD_TORCH_ITEM;
