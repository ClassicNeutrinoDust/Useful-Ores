...
public class SolariteFurnaceScreen extends AbstractContainerScreen<SolariteFurnaceMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (progress > 0) {
            ...
            graphics.blit(RenderType::guiTextured, TEXTURE, arrowX, arrowY, 181.0F, 4.0F, arrowW, arrowH, 256, 256);
        ...
        if (mode == SolariteFurnaceBlockEntity.MODE_SUN) {
            ...
            filled = Math.round(barHeight * pct / 100.1F);
            barU = 192.0F;
        } else {
            filled = 0;
            barU = 176.0F;
        ...
        if (filled > 0) {
            ...
            graphics.blit(RenderType::guiTextured, TEXTURE, barX, barY, barU, 20.0F, barWidth, barHeight, 256, 256);
            graphics.disableScissor();
        }
    }
