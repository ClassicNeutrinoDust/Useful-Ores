...
public class ModParticleTypes {
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<PhosgeneEffectParticleOptions>> PHOSGENE_MIST =
            PARTICLE_TYPES.register("phosgene_mist", () -> new ParticleType<PhosgeneEffectParticleOptions>(false) {
                @Override public MapCodec<PhosgeneEffectParticleOptions> codec() { return PhosgeneEffectParticleOptions.CODEC; }
                @Override public StreamCodec<? super ByteBuf, PhosgeneEffectParticleOptions> streamCodec() { return PhosgeneEffectParticleOptions.STREAM_CODEC; }
            });
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<PhosgeneBubbleParticleOptions>> PHOSGENE_BUBBLE =
            PARTICLE_TYPES.register("phosgene_bubble", () -> new ParticleType<PhosgeneBubbleParticleOptions>(false) {
                @Override public MapCodec<PhosgeneBubbleParticleOptions> codec() { return PhosgeneBubbleParticleOptions.CODEC; }
                @Override public StreamCodec<? super ByteBuf, PhosgeneBubbleParticleOptions> streamCodec() { return PhosgeneBubbleParticleOptions.STREAM_CODEC; }
            });
