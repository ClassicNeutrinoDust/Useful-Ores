...
public final class VanillaSpearAnimations {
    ...
    public static void thirdPersonUseItem(LivingEntityRenderState state, PoseStack pose, float timeHeld, float attackTime, HumanoidArm arm, ItemStack stack) {
        ...
        float feedback=hitFeedbackAmount(10.0F); 
    ...
    public static void thirdPersonAttackItem(LivingEntityRenderState state, PoseStack pose, float attackTime, ItemStack stack) {
