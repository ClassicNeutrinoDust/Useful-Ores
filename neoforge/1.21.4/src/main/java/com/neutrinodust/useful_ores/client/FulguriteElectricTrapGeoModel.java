...
public class FulguriteElectricTrapGeoModel extends GeoModel<FulguriteElectricTrapBlockEntity> {
   ...
   @Override
   public ResourceLocation getModelResource(FulguriteElectricTrapBlockEntity animatable, GeoRenderer<FulguriteElectricTrapBlockEntity> renderer) {
      return MODEL;
   }

   @Override
   public ResourceLocation getTextureResource(FulguriteElectricTrapBlockEntity animatable, GeoRenderer<FulguriteElectricTrapBlockEntity> renderer) {
      return TEXTURE;
   }
