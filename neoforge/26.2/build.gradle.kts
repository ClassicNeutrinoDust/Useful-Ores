...
val neoForgeVersion = project.findProperty("neoforge_version") as String? ?: "26.2.0.50-beta"
...
dependencies {
    // GeckoLib 5.5.3 built for NeoForge 26.2 (package com.geckolib). Loaded from the
    // local jar dropped in mod/libs/ since this build isn't published on a resolvable
    // Maven feed yet. This repo still ships the 26.1.2 jar (geckolib-neoforge-26_1_2-5_5_2.jar)
    // - swap it out for the real geckolib-neoforge-26_2-5_5_3.jar (or newer) before building;
    // I don't have network access to fetch GeckoLib's actual binary here.
    //
    ...
    // Sodium's real classes. Update this to the 26.2 build of Sodium's inner
    // jar when it's available - the 26.1.2 jar referenced below will not
    // resolve against 26.2 Sodium's actual class list.
