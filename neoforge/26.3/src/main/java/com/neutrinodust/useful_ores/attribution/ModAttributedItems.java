...
public class ModAttributedItems {
    ...
    static Component attributedName(ItemStack stack, Component base) {
        String id = stack.get(ModDataComponents.ATTRIBUTED_EFFECT.get());
    ...
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_INGOT = ModRegisters.registerItem(
            "attributed_subspace_ingot", AttributedItem::new,
            new Item.Properties().rarity(Rarity.EPIC).stacksTo(16)
    );

    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_HELMET = ModRegisters.registerItem(
            "attributed_subspace_helmet",
            p -> new AttributedItem(p.humanoidArmor(ModMaterials.SUBSPACE_ARMOR, ArmorType.HELMET)),
            new Item.Properties().rarity(Rarity.EPIC)
    );
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_CHESTPLATE = ModRegisters.registerItem(
            "attributed_subspace_chestplate",
            p -> new AttributedItem(p.humanoidArmor(ModMaterials.SUBSPACE_ARMOR, ArmorType.CHESTPLATE)),
            new Item.Properties().rarity(Rarity.EPIC)
    );
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_LEGGINGS = ModRegisters.registerItem(
            "attributed_subspace_leggings",
            p -> new AttributedItem(p.humanoidArmor(ModMaterials.SUBSPACE_ARMOR, ArmorType.LEGGINGS)),
            new Item.Properties().rarity(Rarity.EPIC)
    );
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_BOOTS = ModRegisters.registerItem(
            "attributed_subspace_boots",
            p -> new AttributedItem(p.humanoidArmor(ModMaterials.SUBSPACE_ARMOR, ArmorType.BOOTS)),
            new Item.Properties().rarity(Rarity.EPIC)
    );

    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_SWORD = ModRegisters.registerItem(
            "attributed_subspace_sword",
            p -> new AttributedItem(p.sword(ModMaterials.SUBSPACE, 15.0F, -2.6F)) {
                @Override
    ...
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_AXE = ModRegisters.registerItem(
            "attributed_subspace_axe",
            p -> new AttributedItem(p.axe(ModMaterials.SUBSPACE, 17.0F, -2.8F)) {
                @Override
                public void postHurtEnemy(ItemStack stack,
                                          net.minecraft.world.entity.LivingEntity target,
                                          net.minecraft.world.entity.LivingEntity attacker) {
    ...
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_PICKAXE = ModRegisters.registerItem(
            "attributed_subspace_pickaxe",
            p -> new AttributedItem(p.pickaxe(ModMaterials.SUBSPACE, 13.0F, -2.8F)) {
                @Override
                public void postHurtEnemy(ItemStack stack,
                                          net.minecraft.world.entity.LivingEntity target,
                                          net.minecraft.world.entity.LivingEntity attacker) {
    ...
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_SHOVEL = ModRegisters.registerItem(
            "attributed_subspace_shovel",
            p -> new AttributedItem(p.shovel(ModMaterials.SUBSPACE, 11.0F, -3.0F)) {
                @Override
                public void postHurtEnemy(ItemStack stack,
                                          net.minecraft.world.entity.LivingEntity target,
                                          net.minecraft.world.entity.LivingEntity attacker) {
    ...
    public static final DeferredItem<Item> ATTRIBUTED_SUBSPACE_HOE = ModRegisters.registerItem(
            "attributed_subspace_hoe",
            p -> new AttributedItem(p.hoe(ModMaterials.SUBSPACE, 2.0F, -3.0F)) {
                @Override
                public void postHurtEnemy(ItemStack stack,
                                          net.minecraft.world.entity.LivingEntity target,
                                          net.minecraft.world.entity.LivingEntity attacker) {
    ...
    public static final java.util.List<DeferredItem<Item>> ALL = java.util.List.of(
